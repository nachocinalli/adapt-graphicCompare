...
export default function GraphicCompare(props) {
  const { _id, _graphic1, _graphic2, _value, onChange, _globals } = props;
    ...
    <div className='component__inner graphiccompare__inner'>
      ...
      <div className='component__widget graphiccompare__widget' ref={widgetEl}>
        <div className='graphiccompare__container'>
          ...
          <div
            className='graphiccompare__image graphiccompare__image-2'
            style={{ width: _value + '%' }}
          >
            <img
              style={{
                maxWidth: widgetEl.current
                  ? widgetEl.current.offsetWidth
                  : '100%'
              }}
              src={_graphic2.src}
          ...
          <label htmlFor={`graphiccompare-input-${_id}`}>
            <span className='aria-label'>
              {compile(_globals._components?._graphicCompare?.ariaLabel)}
            </span>
            <input
              id={`graphiccompare-input-${_id}`}
              type='range'
              value={_value}
